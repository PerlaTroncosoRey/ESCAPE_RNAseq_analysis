...
# Files generated by this pipeline will be save in folder output/
...
and Trim Galore! (Felix Krueger, The Babraham Institute).
...
Output directories "hisat2", "ballgown", "sortmerna", "trimgalore" will be created in the 
